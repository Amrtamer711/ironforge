  ...
  return (
    <div className="h-full min-h-0">
      <Card className="h-full">
        ...
        <CardContent className="text-sm text-black/60 dark:text-white/65 space-y-4">
          <div className="flex items-center justify-between rounded-2xl bg-white/60 dark:bg-white/5 ring-1 ring-black/5 dark:ring-white/10 p-4 shadow-soft">
            <div>
          ...
          <div className="space-y-3 rounded-2xl bg-white/60 dark:bg-white/5 ring-1 ring-black/5 dark:ring-white/10 p-4 shadow-soft">
