  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3">
      ...
      <div className="flex-1 min-h-0">
        <div className={tab === "users" ? "h-full min-h-0" : "hidden"} aria-hidden={tab !== "users"}>
        ...
        <div className={tab === "companies" ? "h-full min-h-0" : "hidden"} aria-hidden={tab !== "companies"}>
        ...
        <div className={tab === "profiles" ? "h-full min-h-0" : "hidden"} aria-hidden={tab !== "profiles"}>
        ...
        <div
          className={tab === "permission-sets" ? "h-full min-h-0" : "hidden"}
          aria-hidden={tab !== "permission-sets"}
        >
        ...
        <div className={tab === "permissions" ? "h-full min-h-0" : "hidden"} aria-hidden={tab !== "permissions"}>
