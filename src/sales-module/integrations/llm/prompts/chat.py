...
def get_main_system_prompt(
    ...
    return (
        ...
        f"      - Example: 'proposal for helix' → location='helix' (system handles expansion)\n\n"
        ...
        f"      - Example: 'helix and dna01' → ALLOWED (dna01 content will appear twice)\n"
        ...
        f"      - Example: 'combined proposal for helix at 300k' → VALID (helix has multiple networks)\n"
        ...
        f"      - Example: 'helix and oryx combined at 500k' → helix (4 networks) + oryx = 5 sections\n"
        f"      - Example: 'separate proposals for helix and landmark' → 2 PDFs\n\n"
        ...
        f"═══════════════════════════════════════════════════════════════════\n\n"
        f"🔴 DISPLAY NAMES VS LOCATION KEYS - CRITICAL:\n"
