...
def get_base_tools() -> list[ToolDefinition | RawTool]:
        ...
        ToolDefinition(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "side": {"type": "string", "description": "Optional billboard side: 'gold', 'silver', 'single_side', or 'all' (default). Use 'all' for random selection from all side variations.", "enum": ["gold", "silver", "single_side", "all"]},
                    "venue_type": {"type": "string", "description": "Optional venue type: 'indoor', 'outdoor', or 'all' (default). Indoor venues have different frame configurations.", "enum": ["indoor", "outdoor", "all"]},
                    "asset_type_key": {"type": "string", "description": "Optional asset type key for traditional networks (networks with multiple asset types). Only needed for non-standalone locations. The system will auto-detect if not provided."},
