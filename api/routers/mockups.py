...
@router.get("/mockup")
async def mockup_setup_page(user: AuthUser = Depends(require_any_role("admin"))):
...
async def delete_mockup_photo(location_key: str, photo_filename: str, time_of_day: str = "all", finish: str = "all", user: AuthUser = Depends(require_any_role("admin"))):
